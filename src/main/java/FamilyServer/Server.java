...
public class Server {
    ...
    private void run(String portNumber) {
        ...
        // that may occur.
        System.out.println("Initializing HTTP FamilyServer.Server");
        ...
        // "/user/register" URL path, it will forward the request to ListGamesHandler
        // for processing.
        ...
        System.out.println("FamilyServer.Server started on port" + portNumber);
    }
